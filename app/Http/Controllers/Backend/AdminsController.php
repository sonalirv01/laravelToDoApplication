...
class AdminsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $fromAddress = 'sonalisv01@gmail.com'; // Change this to your email address
        $fromName = 'sonali'; // Change this to your name
        $from = [$fromAddress, $fromName];
    
        //Mail::to($request->email)->send((new WelcomeEmail($request->name, $request->roles))->from($from));
