    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Todo Edit</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.todos.index') }}">All Todos</a></li>
                    <li><span>Edit Todo - {{ $todo->title }}</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Edit Todo - {{ $todo->name }}</h4>
                    ...
                    <form action="{{ route('admin.todos.update', $todo->id) }}" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="email">Todo Description</label>
                                <input type="text" class="form-control" id="description" name="description" placeholder="Enter Email" value="{{ $todo->description }}">
                            </div>
                        </div>
